        ...
        {fase === 'intro' && (
          <>
            <p className="text-center text-gray-700 leading-relaxed font-medium">
              {"Para participar do "}<strong className="text-red-700">Projeto OBA®</strong>{" você precisa criar um "}<strong>ACESSO (LOGIN/SENHA)</strong>{" e se cadastrar na plataforma… em alguns segundos você iniciará esse processo. "}<strong className="text-red-600">Vamos!…</strong>
            </p>
            <div className="flex justify-center mt-6">
              <PlayButton onClick={() => setFase('cpf')} label="VAMOS!" ariaLabel="Começar"
                playColor="#b91c1c" labelColor="#b91c1c" ringColor="rgba(185,28,28,0.55)" />
            </div>
          </>
        )}
