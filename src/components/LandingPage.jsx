...
const LANDING_CSS = `
  *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .btn-sm { padding: 0.5rem 1.2rem; border-radius: 8px; font-size: 0.85rem; font-weight: 600; text-decoration: none; transition: all 0.2s; display: inline-flex; align-items: center; cursor: pointer; border: none; }
  ...
  .hero h1 { font-family: 'DM Sans', sans-serif; font-size: 3.2rem; line-height: 1.15; color: var(--text); margin-bottom: 1.2rem; font-weight: 800; }
  ...
  .oba-home-btn { background: linear-gradient(135deg, #475569, #1E293B); border-radius: 12px; padding: 1rem 1.5rem; text-decoration: none; display: flex; flex-direction: column; gap: 0.2rem; transition: transform 0.2s; width: 100%; max-width: 300px; }
  .oba-home-btn:hover { transform: translateY(-2px); }
  ...
  .cycle-step .icon { font-size: 1.2rem; min-width: 28px; text-align: center; }
  .cycle-step .desc { font-size: 0.85rem; color: var(--text-sec); line-height: 1.6; padding-top: 0.1rem; }
  .fairy-mini { width: 22px; height: 22px; object-fit: contain; }
  ...
  /* COMO FUNCIONA */
  .como-tabs { display: flex; gap: 0.5rem; margin-top: 2rem; margin-bottom: 2rem; background: var(--gray-bg); border-radius: 10px; padding: 4px; width: fit-content; }
  .como-tab { padding: 0.6rem 1.5rem; border-radius: 8px; font-size: 0.88rem; font-weight: 600; border: none; cursor: pointer; background: none; color: var(--text-sec); transition: all 0.2s; font-family: inherit; }
  .como-tab.active { background: white; color: var(--text); box-shadow: 0 1px 4px rgba(0,0,0,0.08); }
  ...
  .reward-text p { color: rgba(255,255,255,0.7); font-size: 0.85rem; }
  .reward-text strong { color: #86EFAC; }
  .reward-amount { font-size: 2rem; font-weight: 800; color: #86EFAC; white-space: nowrap; }
  .patient-features { display: grid; grid-template-columns: repeat(3, 1fr); gap: 1rem; margin-bottom: 2rem; }
  .pf-card { background: var(--gray-bg); border-radius: 12px; padding: 1.2rem; text-align: center; }
  ...
  .pricing-box { background: var(--gray-bg); border-radius: 14px; padding: 1.5rem; text-align: center; }
  ...
  .pix-tag { background: white; border: 1px solid var(--border2); border-radius: 8px; padding: 0.4rem 0.8rem; font-size: 0.8rem; color: var(--text-sec); }
  ...
  .btn-oba-main { background: linear-gradient(135deg, var(--oba-orange), var(--oba-blue)); color: var(--white); box-shadow: 0 6px 25px rgba(232,114,12,0.3); }
  ...
  .cta-doc li::before { content: '✓'; color: var(--cherry); font-weight: 700; font-size: 0.75rem; }
  .cta-pat li { font-size: 0.84rem; color: rgba(255,255,255,0.9); padding: 0.3rem 0; display: flex; align-items: center; gap: 0.4rem; }
  .cta-pat li::before { content: '✓'; color: rgba(255,255,255,0.6); font-weight: 700; font-size: 0.75rem; }
  .btn-doc-cta { background: var(--wine); color: var(--white); width: 100%; justify-content: center; font-family: inherit; border: none; cursor: pointer; }
  .btn-doc-cta:hover { background: var(--cherry); transform: translateY(-2px); }
  .btn-pat-cta { background: #9CA3AF; color: var(--white); width: 100%; justify-content: center; border: 1.5px solid #9CA3AF; font-family: inherit; cursor: pointer; }
  .btn-pat-cta:hover { background: #374151; border-color: #374151; transform: translateY(-2px); }
  ...
  @media (max-width: 900px) {
    ...
    .oba-home-btn { align-self: center; }
  }
`

// ─── Matriz simplificada RedFairy ─────────────────────────────────────────────
...
const rfMatrix = [
  { id:3,  label:'SAUDÁVEL', color:'green',
    ...
    diag:'Produção normal de hemoglobina e células vermelhas, com boa reserva de ferro. Sem indicação de anemia ou siderose. Mantenha acompanhamento periódico.',
  ...
  { id:10, label:'SIDEROPENIA INCIPIENTE SEM ANEMIA', color:'yellow',
    ...
    diag:'Hemoglobina normal, mas com sinais de depleção incipiente de ferro — anisocitose e hipoferritinemia. O organismo ainda mantém a produção, mas a reserva está comprometida.',
  ...
  { id:11, label:'ANEMIA FERROPRIVA MODERADA', color:'orange',
    ...
    diag:'Deficiência de ferro com impacto sobre a produção de hemoglobina e hemácias, produzindo anemia moderada, com microcitose e anisocitose. Reposição de ferro necessária.',
  ...
  { id:12, label:'ANEMIA FERROPRIVA IMPORTANTE', color:'red',
    ...
    diag:'Anemia ferropriva importante. O impacto negativo sobre a produção de hemoglobina é substancial. Exige intervenção médica imediata.',
  ...
  { id:5,  label:'PROCESSO INFLAMATÓRIO OU DOENÇA CRÔNICA', color:'yellow',
    ...
    diag:'Ferritina elevada com saturação normal. Processos inflamatórios agudos ou crônicos, neoplasias ou doenças degenerativas podem produzir esses achados.',
  ...
  { id:7,  label:'EXCESSO DE FERRO / SIDEROSE', color:'orange',
    ...
    diag:'Ferritina e saturação da transferrina elevadas, traduzindo siderose significativa. O excesso de ferro pode causar dano oxidativo a órgãos.',
    rec:'Procure orientação de hematologista para investigar a siderose. Sangrias terapêuticas podem ser indicadas.' },
  { id:8,  label:'COMPATÍVEL COM HEMOCROMATOSE', color:'red',
    ...
    diag:'Siderose maior — ferritina e saturação muito elevadas. As portadoras de hemocromatose têm mutação dupla no gene HFE. Sangrias terapêuticas são o tratamento indicado.',
    rec:'Avaliação urgente com hematologista. Sangrias terapêuticas deverão ser indicadas. Pesquise mutações no gene HFE.' },
  { id:80, label:'HEMOGLOBINA ACIMA DO NORMAL — ERITROCITOSE', color:'red',
    ...
    diag:'Hemoglobina acima do normal. Pode corresponder a uso de diuréticos, testosterona, eritropoetina, ou doenças pulmonares e hematológicas.',
  ...
  { id:14, label:'VEGETARIANO/A COMPENSADO/A', color:'green',
    ...
    diag:'Normal quanto à produção de hemoglobina e células vermelhas. A suplementação de ferro e vitamina B12 parece adequada.',
    rec:'Procure orientação de hematologista. A vegetariana deve ser avaliada por médico antes de doar sangue.' },
  { id:17, label:'VEGETARIANO/A COM ANEMIA FERROPRIVA', color:'orange',
    ...
    diag:'Anemia moderada por deficiência de ferro, provavelmente secundária a dieta insuficiente. Vegetarianos também são deficientes de vitamina B12.',
  ...
  { id:25, label:'BARIÁTRICO/A COM SUPORTE ADEQUADO', color:'green',
    ...
    diag:'Normal quanto à produção de hemoglobina com reserva de ferro normal, apesar do déficit absortivo da bariátrica. Suplementação parenteral de ferro e B12 está adequada.',
    rec:'Avaliação com hematologista. A bariátrica deve ser avaliada por médico antes de doar sangue.' },
  { id:35, label:'ANEMIA IMPORTANTE COM HEMORRAGIA E SIDEROPENIA', color:'red',
    ...
    diag:'Anemia importante por deficiência de ferro possivelmente causada pela hemorragia, com sideropenia grave. Requer intervenção médica imediata.',
  ...
  { id:82, label:'ANEMIA MACROCÍTICA — PROVÁVEL DÉFICIT DE FOLATOS', color:'orange',
    ...
    diag:'Anemia macrocítica em alcoolista — padrão compatível com deficiência de ácido fólico. O álcool interfere na absorção e metabolismo do folato.',
    rec:'Avaliação com hematologista. Dosagem de folatos e vitamina B12. Suplementação de ácido fólico essencial. Suspender o álcool.' },
]
...
export default function LandingPage({ onModoMedico, onModoPaciente }) {
  ...
  useEffect(() => {
    ...
    if (!document.getElementById('landing-fonts')) {
      ...
      link.href = 'https://fonts.googleapis.com/css2?family=DM+Sans:opsz,wght@9..40,300;9..40,400;9..40,500;9..40,600;9..40,700;9..40,800&family=DM+Serif+Display:ital@0;1&display=swap'
      link.rel  = 'stylesheet'
  ...
  function rfAvaliar() {
    ...
    if ([hb, ferr, vcm, rdw, sat].some(isNaN)) {
      setRfErro('Preencha todos os campos laboratoriais.')
      return
    }
    if (!idade || idade < 12 || idade > 100) {
      setRfErro('Informe uma idade válida (12–100 anos).')
      return
    }

    const inp = {
      hemoglobina: hb, ferritina: ferr, vcm, rdw, satTransf: sat,
      bariatrica:   rfForm.bariatrica,
      vegetariano:  rfForm.vegetariano,
      perda:        rfForm.perda,
      alcoolista:   rfForm.alcoolista,
      transfundido: rfForm.transfundido,
    }
    ...
    if (res) {
      ...
      setRfErro('Combinação não encontrada na versão simplificada. Acesse o RedFairy completo para avaliação com todos os padrões clínicos.')
    }
  }
  ...
  const inputStyle = {
    ...
    borderRadius:8, padding:'0.65rem 0.8rem', color:'white', fontSize:'0.92rem',
    fontFamily:'inherit', outline:'none',
  }
  const labelStyle = {
    display:'block', fontSize:'0.78rem', fontWeight:700,
    color:'rgba(255,255,255,0.5)', textTransform:'uppercase',
    letterSpacing:1, marginBottom:'0.4rem',
  }
  ...
  return (
    <div style={{ fontFamily:"'DM Sans', sans-serif" }}>
      ...
      <section className="hero">
        <div className="hero-wrap">
          <div className="reveal">
            ...
            <div
              className={`hero-textbox${showHtbImg ? ' reveal-img' : ''}`}
            ...
            <p className="hero-desc">
              Avalie o eritron e o metabolismo do ferro com precisão clínica.
              Com apenas alguns dados laboratoriais e de contexto de vida,
              monitore a evolução da sua hemoglobina e receba orientações
              terapêuticas ajustadas às suas necessidades. Viva melhor para viver mais!
            </p>
      ...
      {/* ── FILOSOFIA ────────────────────────────────────────────────────────── */}
      <section
        className={`filosofia${showFilImg ? ' reveal-img' : ''}`}
        id="filosofia"
          ...
          <div className="filosofia-grid">
            ...
            <div className="filosofia-visual reveal" style={{ transitionDelay:'0.1s' }}>
              <div className="cycle-card">
                ...
                <div className="cycle-step"><div className="icon"><img src={logo} className="fairy-mini" alt="Fadinha" /></div><div className="desc">Hemoglobina — A fada vermelha, que com o ferro faz você respirar.</div></div>
                ...
                <div className="cycle-step"><div className="icon" style={{ color:'#DC2626' }}>❤️</div><div className="desc">Perfusão — Ela entrega oxigênio a cada célula do corpo e capta o gás carbônico do metabolismo.</div></div>
      ...
      <section className="terapeutica">
        <div className="container">
          <div className="reveal">
            ...
            <p className="sdesc">O RedFairy é um algoritmo médico, que não apenas avalia: ele orienta.<br />Gera recomendações personalizadas para tratamento com base no perfil completo do paciente.</p>
          </div>
      ...
      <section className="como" id="como-funciona">
        <div className="container">
          ...
          <div className="como-tabs reveal">
            ...
            <div className="como-panel">
              ...
              <div className="reward-banner reveal">
                <div className="reward-text">
                  ...
                  <p>Quando o paciente que você avaliou se cadastra, você recebe <strong>DEZ DÓLARES DIGITAIS</strong> na sua wallet KlipBit.</p>
                </div>
      ...
      <section id="avaliar" style={{ background:'var(--dark-bg)', padding:'5.5rem 2rem' }}>
        <div className="container">
          <div className="center reveal" style={{ marginBottom:'2.5rem' }}>
            ...
            <p className="sdesc" style={{ color:'rgba(255,255,255,0.55)', margin:'0 auto' }}>
            ...
            <div style={{ background:'var(--dark-card)', border:'1px solid rgba(255,255,255,0.06)', borderRadius:16, padding:'2rem', marginBottom:'1.5rem' }}>
              ...
              <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:'1rem', marginBottom:'1rem' }}>
                ...
                <div>
                  ...
                  <input type="number" min="12" max="100" placeholder="Ex: 35"
                    value={rfForm.idade} onChange={e => handleFormChange('idade', e.target.value)}
                    style={inputStyle} />
                </div>
              </div>
              ...
              <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:'1rem', marginBottom:'1rem' }}>
                <div>
                  <label style={labelStyle}>Hemoglobina (g/dL)</label>
                  <input type="number" step="0.1" placeholder="Ex: 12.5"
                    value={rfForm.hb} onChange={e => handleFormChange('hb', e.target.value)}
                    style={inputStyle} />
                </div>
                <div>
                  <label style={labelStyle}>Ferritina (ng/mL)</label>
                  <input type="number" step="0.1" placeholder="Ex: 15"
                    value={rfForm.ferritina} onChange={e => handleFormChange('ferritina', e.target.value)}
                    style={inputStyle} />
                </div>
              </div>
              ...
              <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr 1fr', gap:'1rem', marginBottom:'1.5rem' }}>
                <div>
                  <label style={labelStyle}>VCM (fL)</label>
                  <input type="number" step="0.1" placeholder="Ex: 82"
                    value={rfForm.vcm} onChange={e => handleFormChange('vcm', e.target.value)}
                    style={inputStyle} />
                </div>
                <div>
                  <label style={labelStyle}>RDW (%)</label>
                  <input type="number" step="0.1" placeholder="Ex: 13.5"
                    value={rfForm.rdw} onChange={e => handleFormChange('rdw', e.target.value)}
                    style={inputStyle} />
                </div>
                <div>
                  <label style={labelStyle}>Sat. Transf. (%)</label>
                  <input type="number" step="0.1" placeholder="Ex: 25"
                    value={rfForm.sat} onChange={e => handleFormChange('sat', e.target.value)}
                    style={inputStyle} />
                </div>
              </div>
                ...
                <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fill, minmax(160px,1fr))', gap:'0.5rem' }}>
                  {[
                    ...
                    <label key={field} style={{
                      ...
                      color: rfForm[field] ? 'white' : 'rgba(255,255,255,0.7)',
                      transition:'all 0.2s',
                    }}>
                      <input type="checkbox" checked={!!rfForm[field]}
              ...
              <div style={{ marginBottom:'1.5rem' }}>
                ...
                <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fill, minmax(160px,1fr))', gap:'0.5rem' }}>
                  {[
                    ['aspirina','Aspirina','Uso contínuo'],
                    ['b12','Vitamina B12','Últimos 3 meses'],
                    ['ferroMed','Ferro Oral/EV','Últimos 2 anos'],
                  ].map(([field, lbl, sub]) => (
                    <label key={field} style={{
                      display:'flex', alignItems:'center', gap:'0.5rem',
                      padding:'0.6rem 0.8rem',
              ...
              <button onClick={rfAvaliar} style={{
                width:'100%', background:'var(--wine)', color:'white',
              ...
              return (
                <div style={{ background:c.bg, border:`1px solid ${c.border}`, borderRadius:16, overflow:'hidden' }}>
                  <div style={{ background:c.badge, padding:'1rem 1.5rem', display:'flex', alignItems:'center', justifyContent:'space-between' }}>
                    ...
                    <span style={{ fontSize:'0.75rem', background:'rgba(255,255,255,0.2)', color:'white', padding:'0.3rem 0.7rem', borderRadius:6, fontWeight:700 }}>
                      ID {rfResultado.id}
                    </span>
                  </div>
                  <div style={{ padding:'1.5rem', display:'flex', flexDirection:'column', gap:'1rem' }}>
                    ...
                    <div style={{ background:'rgba(220,38,38,0.15)', border:'1px solid rgba(220,38,38,0.25)', borderRadius:10, padding:'1rem', textAlign:'center' }}>
                      <p style={{ color:'rgba(255,255,255,0.6)', fontSize:'0.8rem', marginBottom:'0.75rem' }}>
                        Para orientações terapêuticas completas com dosagens e acompanhamento:
                      </p>
                      <button onClick={onModoMedico} style={{
        ...
        <div className="container">
          ...
          <div className="cta-cards reveal">
            <div className="cta-c cta-doc">
              ...
              <button className="btn btn-doc-cta" onClick={onModoMedico}>Acessar como Médico</button>
            </div>
            <div className="cta-c cta-pat">
              ...
              <button className="btn btn-pat-cta" onClick={onModoPaciente}>Acessar como Paciente</button>
            </div>
          </div>
        </div>
      </section>
