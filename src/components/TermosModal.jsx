...
function ConteudoMedico() {
  return (
    <>
      ...
      {/* (R2, 09/2026) O antigo "Programa de Afiliados 4DOC" prometia benef\u00edcio
          por paciente trazido. Isso saiu: remunera-se TRABALHO PRESTADO, nunca
          capta\u00e7\u00e3o de clientela (CFM 2.336/2023 e CFM 2.170/2017). N\u00e3o
          reintroduzir promessa de b\u00f4nus por indica\u00e7\u00e3o neste item. */}
      <p><strong>{"5. Remunera\u00e7\u00e3o por avalia\u00e7\u00e3o."}</strong>{" A avalia\u00e7\u00e3o de paciente realizada pelo profissional na plataforma \u00e9 remunerada, uma vez por paciente avaliado, pelo valor vigente informado no sistema no momento da avalia\u00e7\u00e3o. Trata-se de contrapartida por trabalho t\u00e9cnico efetivamente prestado. N\u00c3O h\u00e1, sob nenhuma forma, pagamento, comiss\u00e3o ou b\u00f4nus por paciente indicado, encaminhado ou cadastrado \u2014 o encaminhamento existe apenas como v\u00ednculo cl\u00ednico, para que o profissional acompanhe o seu pr\u00f3prio paciente. O pagamento fica condicionado \u00e0 valida\u00e7\u00e3o do registro profissional. Os valores podem ser alterados com aviso pr\u00e9vio de 30 dias."}</p>
...
function ConteudoPaciente({ anuidadeBRL, solicitacaoBRL, marca = 'Projeto OBA®' }) {
  ...
  return (
    <>
      ...
      <p><strong>{"2. Quem pode usar."}</strong>{" A plataforma pode ser usada por pessoas a partir de 12 anos com CPF v\u00e1lido. Menores de 18 anos devem ser cadastrados e acompanhados por um respons\u00e1vel legal, que se responsabiliza pelo uso da plataforma e pela veracidade dos dados informados."}</p>
      ...
      {/* (R3/R4, 09/2026) Cr\u00e9dito de indica\u00e7\u00e3o NUNCA vira dinheiro: s\u00f3 abate uso
          da plataforma. \u00c9 a fronteira que separa desconto de fidelidade (l\u00edcito)
          de pagamento por paciente trazido (capta\u00e7\u00e3o de clientela). N\u00e3o
          reintroduzir saque, dep\u00f3sito ou "excedente pago" neste texto. */}
      <p><strong>{"3.1. Desconto de boas-vindas e cr\u00e9ditos."}</strong>{" Se voc\u00ea chegou indicado por algu\u00e9m, ganha um desconto de boas-vindas na primeira anuidade, pelo valor vigente informado no momento do pagamento. Se voc\u00ea indicar outras pessoas, cada uma que se cadastrar e assinar gera um cr\u00e9dito para voc\u00ea. Esses cr\u00e9ditos servem EXCLUSIVAMENTE para abater o que voc\u00ea paga na pr\u00f3pria plataforma \u2014 anuidade e documentos m\u00e9dicos. Eles n\u00e3o s\u00e3o resgat\u00e1veis, n\u00e3o s\u00e3o convertidos em dinheiro e n\u00e3o s\u00e3o depositados em conta, em nenhuma hip\u00f3tese."}</p>
