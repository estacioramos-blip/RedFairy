...
const content = `import { maleMatrix } from './maleMatrix.js';
...
fs.writeFileSync('src/engine/decisionEngine.js', content, 'utf8');
console.log('Done! decisionEngine.js reescrito com encoding correto.');